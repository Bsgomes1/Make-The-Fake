class Play extends Phaser.Scene {
    ...
    //     // // SHOOTING LOGIC (Pressing Spacebar while in the air)
    //     // // if (isShooting) {
    //     // //     this.player.play(this.lastDirection === 'left' ? 'left-shoot' : 'right-shoot', true)
    //     // //     this.sound.play('shoot')
    //     // // }

    //     // // When the player presses the shoot button
    //     // if (isShooting) {
    //     //     // Play shooting animation and sound
    //     //     this.player.play(this.lastDirection === 'left' ? 'left-shoot' : 'right-shoot', true)
    //     //     this.sound.play('shoot')
    //     // } else {
    //     //     // Continue playing the regular animation or idle animation
    //     //     if (this.cursors.left.isDown) {
    //     //         this.player.play('left', true) // Regular left animation
    //     //     } else if (this.cursors.right.isDown) {
    //     //         this.player.play('right', true) // Regular right animation
    //     //     } else {
    ...
    // if (isShooting){ //&& !isMoving && !isJumping && !isCrouching) {
    //     // Play shooting animation and sound
    //     this.player.play(this.lastDirection === 'left' ? 'left-shoot' : 'right-shoot', true)
    //     this.sound.play('shoot')
    // } else if (!isShooting) {
    //     // Default to regular animation (move, idle, or jump)
    //     if (this.cursors.left.isDown) {
    //         this.player.play('left', true) // Regular left animation
    //     } else if (this.cursors.right.isDown) {
    //         this.player.play('right', true) // Regular right animation
    ...
    //         this.player.play(this.lastDirection === 'left' ? 'left-shoot' : 'right-shoot', true)
    //         this.sound.play('shoot')
    //         return  // << Prevents other animations from overriding shooting
    //     }
